...
void Make2DPlot_HPK() {
  ...
  TH2F *hCount = new TH2F( "hCount",";;;",40, 13.275, 14.575, 40, 21., 22.375);

  // gStyle->SetPalette(1); //kBird

  ch.Draw("y1/1000.:x1/1000.>>h1","1000*amp[1]*((x1-13900.)**2+(y1-21700.)**2<500**2 )","colz");
  ch.Draw("y1/1000.:x1/1000.>>hCount","((x1-13900.)**2+(y1-21700.)**2<500**2)","colz");
  ...
  h1->SetStats(0);
  h1->SetTitle("");
  h1->GetZaxis()->SetRangeUser(0,150);
  h1->GetXaxis()->SetTitle("x-coordinate [mm]");
  h1->GetYaxis()->SetTitle("y-coordinate [mm]");
  h1->Draw("colz");
  h1->GetXaxis()->SetTitleSize(0.05);
