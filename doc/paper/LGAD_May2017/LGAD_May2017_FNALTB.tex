...
\begin{figure}[htbp] 
\centering
\includegraphics[width=0.48\textwidth]{figs/HPK_CNM_gap_Xscan.pdf} 
\includegraphics[width=0.48\textwidth]{figs/HPK_CNM_gap_Yscan.pdf} 
\caption{A zoomed version of the efficiency measurement across the X-axis (left) and Y-axis (right) of the HPK 50C-PIX and CNM W9HG11 sensors with 10~$\mu$m binning to show the inter-pixel gap area. Pixel numbering scheme is defined in Fig.~\ref{fig:HPK_Sensors}.} 
\label{fig:FNAL_HPK50C_CNMPIX_ZoomeffXY} 
\end{figure} 
