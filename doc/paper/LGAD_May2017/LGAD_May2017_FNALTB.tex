...
annealed for 80 min at 60$^{\circ}}$C. Afterward the devices were kept in $-20^{\circ}}$C degree storage.
...
of the irradiated HPK 50D sensor is shown in
Fig.~\ref{fig:HPK_irradiated_amp_Map}, and a unifortm amplitude across the
sensor sufrace is observed. In contrast to the CNM sensor, the HPK sensor does
not contain any portions that have active area covered with metalization.
