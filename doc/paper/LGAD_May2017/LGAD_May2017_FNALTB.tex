...
\caption{Efficiency measurement across the X- and Y-axes of the HPK 50D-PIX sensor mounted on the FNAL board. The scan of pixels 1 and 2 along the X-axis, and pixels 1 and 3 along the Y-axis is shown, and pixel numberng scheme is defined in Fig.~\ref{fig:HPK_Sensors}.} 
...
\caption{A zoomed version of the efficiency measurement across the X-axis of the HPK 50D-PIX sensor with 10~$\mu$m binning to show the inter-pixel gap area. Pixel numberng scheme is defined in Fig.~\ref{fig:HPK_Sensors}.} 
...
distribution, and the Most Probable Value (MPV) of the fitted function is
...
Fig.~\ref{fig:HPK_Sensors}. The $\Delta t$ distribution has a distinct shape
where the area under the metalization on top of the sensor shows a shift of
