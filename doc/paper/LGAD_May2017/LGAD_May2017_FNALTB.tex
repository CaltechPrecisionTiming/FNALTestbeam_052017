...
the rise time of pulse from the metallized and un-metallized areas. \textbf {FIXME CNM has some features too, need an image of the CNM metalization area to check.}
...
across the sensor area around 45-50~ps.
...
envisioned at the HL-LHC, the UFSD sensors will be cooled to temperatures below
...
the UFSD sensors performed at $-10$ and $-20^{\circ}$C degrees, and compare the
...
sensors irradiated to $6\times 10^{14}$~n/cm$^2$ are shown in
Figs.~\ref{fig:CNM_irradiated_amp_Map} and \ref{fig:HPK_irradiated_amp_Map}.
From the comparison with the image of the CNM sensor shown in
Fig.~\ref{fig:HPK_Sensors} and the distribution in
...
of the irradiated HPK 50D sensor is shown in Fig.~\ref{fig:HPK_irradiated_amp_Map}, and
a unifortm amplitude across the sensor sufrace is observed. In contrast to the
CNM sensor, the HPK sensor does not contain any portions that have active area
covered with metalization.
