...
resolution around 40~ps across the whole sensor area. \textbf {FIXME explanation for the difference in resolution on two pixels. I suspect this is due to difference in gain in two pre-amps on KU board}.
