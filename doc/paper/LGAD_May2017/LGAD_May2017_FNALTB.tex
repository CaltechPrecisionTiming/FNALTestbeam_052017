...
The area between two pixels is shown in more detail in
...
We compare the width of the no-response area between the CNM and HPK sensors in
Fig.~\ref{fig:UCSC_HPK50C_CNM_ZoomeffXY}. Both sensors in this comparison were
mounted on the 4-channel UCSC board. The HPK 50C-PIX sensor was operated at
-450~V, and CNM W9HG11 sensor at -180~V. Following the same procedure as that
described above for the HPK 50D-PIX, we measure the no-response width to be
110~$\mu$m on the HPK 50C-PIX in X and Y directions, and for the CNM sensor to
be 70$\mu$m in X, and 60~$\mu$m in Y directions.
